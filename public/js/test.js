const fallbackData = [
  {
    ...
    snippet: "Công cụ bạn cần học: Power Automate, AI, APIs",
    messages: [
      {
        author: "User",
        text: "Những công cụ tôi cần?",
        time: "2025-09-19 14:38",
      },
    ],
  },
  {
    id: "c2",
    title: "Ứng dụng Socket",
    time: "2025-09-12 09:02",
    snippet: "Realtime chat, games, IOT",
    messages: [
      {
        author: "User",
        text: "Socket application có tác dụng gì?",
        time: "2025-09-12 09:02",
      },
    ],
  },
...
async function selectConversation(id, push = false) {
  ...
  if (conv) {
    ...
    chatTitle.textContent = "Không tìm thấy cuộc trò chuyện";
    chatSubtitle.textContent = "";
    chatArea.innerHTML = '<div class="message">Không tìm thấy nội dung.</div>';
  }
}
